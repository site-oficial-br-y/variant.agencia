    ...
    <section id="precos" style={{ padding: '90px 24px', background: '#0f0f1a', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ marginTop: 72 }}>
        <div className="reveal" style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h2 style={{ fontSize: 'clamp(1.6rem,3.5vw,2.4rem)', fontWeight: 800, letterSpacing: -1, lineHeight: 1.15, marginBottom: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}><img src="/honk-coin.png" alt="Honk Coin" style={{ width: 36, height: 36, objectFit: 'contain' }} /> Honk Coins</h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 20, maxWidth: 760, margin: '0 auto' }}>
          {[
            ...
            <div key={pkg.id} className="reveal" style={{
              ...
              <div style={{ marginBottom: 8 }}><img src="/honk-coin.png" alt="Honk Coin" style={{ width: 52, height: 52, objectFit: 'contain' }} /></div>
