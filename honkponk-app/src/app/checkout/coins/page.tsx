    ...
    <div style={{ minHeight: '100vh', background: '#0f0f1a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, color: '#fff', fontFamily: 'Inter, -apple-system, sans-serif' }}>
      <div style={{ width: '100%', maxWidth: 640 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: -1, marginBottom: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}><img src="/honk-coin.png" alt="Honk Coin" style={{ width: 36, height: 36, objectFit: 'contain' }} /> Honk Coins</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: 18, marginBottom: 24 }}>
          {COIN_PACKAGES.map(pkg => (
            <div key={pkg.id} style={{
              ...
              <div style={{ marginBottom: 8 }}><img src="/honk-coin.png" alt="Honk Coin" style={{ width: 56, height: 56, objectFit: 'contain' }} /></div>
