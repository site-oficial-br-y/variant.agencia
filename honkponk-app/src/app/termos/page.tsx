    ...
    <div style={{ minHeight: '100vh', background: '#0f0f1a', color: '#fff' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px' }}>
        ...
        {[
          ...
          { title: '2. Descrição do Serviço', content: 'A Honk Ponk é uma ferramenta de prospecção B2B. A partir de um tipo de serviço e uma região, ela reúne empresas que podem ter interesse nesse serviço, com os contatos publicamente disponíveis. As informações vêm de bases públicas de estabelecimentos e podem estar incompletas ou desatualizadas.' },
          ...
          { title: '12. Limitação de Responsabilidade', content: 'A Honk Ponk entrega dados públicos e ferramentas de organização, não resultados comerciais. Não nos responsabilizamos por decisões de negócio tomadas com base nas listas geradas, por imprecisões nas informações de terceiros, nem pelo conteúdo das abordagens que você faz aos contatos.' },
